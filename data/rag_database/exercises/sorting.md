...
```json
{
  ...
  "answer": "Masculine: كِتَاب، قَلَم | Feminine: مَدْرَسَة، طَاوِلَة",
...
```json
{
  "question": "Categorize: بَيْت، نَافِذَة، كُرْسِيّ، غُرْفَة\nGroup by masculine/feminine.",
  "answer": "Masculine: بَيْت، كُرْسِيّ | Feminine: نَافِذَة، غُرْفَة",
...
```json
{
  ...
  "answer": "Definite: الكِتَاب، المَدْرَسَة | Indefinite: كِتَابٌ، مَدْرَسَةٌ",
...
```json
{
  ...
  "answer": "Verbs: كَتَبَ، دَرَسَ | Nouns: كِتَاب، طَاوِلَة | Adjectives: كَبِير، صَغِير",
...
```json
{
  ...
  "answer": "Nominal: الكِتَاب جَدِيد، المُعَلِّم في الفَصْل | Verbal: قَرَأَ الطَّالِب، كَتَبَت الطَّالِبَة",
...
```json
{
  ...
  "answer": "Past: كَتَبَ، دَرَسَ | Present: يَكْتُب، يَدْرُس | Future: سَيَكْتُب، سَيَدْرُس",
...
```json
{
  ...
  "answer": "Form I: كَتَبَ | Form II: عَلَّمَ، تَعَلَّمَ | Form III: كَاتَبَ | Form IV: أَكْرَمَ",
...
```json
{
  ...
  "answer": "Broken: كُتُب، أَقْلَام، بُيُوت | Sound masc: مُعَلِّمُون | Sound fem: طَالِبَات",
...
```json
{
  ...
  "answer": "Nominative: الطَّالِبُ، المُعَلِّمُ | Accusative: الطَّالِبَ، المُعَلِّمَ | Genitive: الطَّالِبِ، المُعَلِّمِ",
